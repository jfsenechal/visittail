<?php
/**
 * visittail functions and definitions
 *
...
if ( ! defined( 'VISITTAIL_VERSION' ) ) {
	// Replace the version number of the theme on each release.
	define( 'VISITTAIL_VERSION', '1.0.0' );
}

if ( ! function_exists( 'visittail_setup' ) ) :
	/**
...
function visittail_scripts() {
	wp_enqueue_style( 'visittail-style', get_stylesheet_uri(), array(), VISITTAIL_VERSION );
	wp_enqueue_script( 'visittail-script', get_template_directory_uri() . '/js/script.min.js', array(), VISITTAIL_VERSION, true );
 ...
 * @return array
 */
function visittail_tinymce_add_class( $settings ) {
	$settings['body_class'] = 'block-editor-block-list__layout';
	return $settings;
}
add_filter( 'tiny_mce_before_init', 'visittail_tinymce_add_class' );
